...
<body style="background-color:#808080;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <a style="color:white" href="https://www.linkedin.com/in/ahmedabdmouleh/"><img src="statics/me.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;"></a>
            <br><br>
            <p style="color:white;">This Website is developed by</p>
            <a style="color:white" href="https://www.linkedin.com/in/ahmedabdmouleh/" 
                          > <h1 style="color:white; text-shadow:2px 2px 2px gray;"> Ahmed Abdmouleh</h1> <h6>(my linkedin)</h6></a>
