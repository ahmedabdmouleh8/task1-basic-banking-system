...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="statics/bangg.png">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/bangg.png">
...
<div id="lock"><img src="statics/rotatephone.png" alt="" style="width:50%; margin-top:50%;"><br>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\bangg.png" alt=""
    ...
    <div class="container-large"
        style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#808080;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;color:rgba(218,219,194,255)
;"><b>Welcome to our Sparks Bank!</b></p>

&nbsp;<img src="statics/sparks.png" alt="" style="width:400px;margin-left:-20%;margin-top:9%;">
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                
                <img src="statics/moneyy.png" class="zoomin" alt="" style="width:0px;margin-left:-20%;">
            </div>
        </div>
    </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px #dadbc2; border-radius:30px; padding:20px 0px 20px 0px; ">
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>How can we help you ?</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#dadbc2; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            <i class="fas fa-users fa-7x"></i><br><br>
                            <a href="all_cust.php"><button type="button" class="btn btn-outline-light mybtn">See All
                                    Customers</button></a><br>
                            <h6>Find all the customers of our bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6>Send money from account to another.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="check_blc.php"><button type="button" class="btn btn-outline-light mybtn">Check
                                    Solde</button></a><br>
                            <h6>Check the balance of your account</h6>
                        </div>
                    </div>
                </div>
            </div>
