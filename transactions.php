...
<body style="background-color:#808080;">
    ...
    <style>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:100%; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:white; text-align:center;">Transfers Records</h1>
            </div>
            <?php
    ...
    if(!$conn){
        ...
        $sql = "SELECT * FROM `transactions`ORDER BY `sr` DESC";
        $result = mysqli_query($conn, $sql);
?>
            <table class="table table-secondary" style="margin-top: 30px;">
                <thead>
                    <tr>
